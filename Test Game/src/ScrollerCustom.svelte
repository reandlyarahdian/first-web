...
onMount(() => {
  document.getElementById("foreground").addEventListener('scroll', run_all);
		document.getElementById("foreground").addEventListener('resize', run_all);
})
...
<svelte-scroller-outer style="
  height: 100vh;
    overflow: hidden;" bind:this={outer}>
